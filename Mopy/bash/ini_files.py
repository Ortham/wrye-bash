...
class IniFileInfo(AIniInfo, AFileInfo):
    ...
    def saveSettings(self, ini_settings, deleted_settings=None, *,
        ...
        """Apply dictionary of settings to ini file. Values in settings
        dictionary can be actual (setting, value) pairs or full ini lines
        ending in newline char. 'value' may be a tuple of ( value, comment),
        which specifies an inline comment. Sections in skip_sections will be
        replaced with the values in ini_settings."""
